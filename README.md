...
A toy geometric constraint solver for learning. Simplified for easy understanding and using only the Go standard library, so there is no magic, just about 2000 lines of code. You can step through it and understand how CAD programs work. 
